...
public class ExitPortalController : MonoBehaviour
{
    ...
    public DungeonMinimap dungeonMinimap; // To clear on exit
    public DungeonGenerator dungeonGenerator; // To reset on re-entry
    ...
    void Start()
    {
        ...
        playerTeleportEffect = player.transform.Find("BigTeleportEffect");
